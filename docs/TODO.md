...
- 🟡 8.3 — QA-031 (Alto: adjuntos de cotización potencialmente accesibles por URL directa) — **implementado y entregado** (carpeta protegida `uploads/cotizaciones/` + endpoint autenticado, `inc/quote-attachments.php` nuevo), pendiente de tu aprobación final. Ver `docs/DECISIONS.md` D-096.
