...
- ⬜ 8.5 — QA-012 (caché de "relacionados"), QA-016 (script inline de metabox sin dependencia formal), QA-035 (autoplay sin pausa accesible), QA-038 (canonical ausente) — 🟡 **integración de código completa**, pendiente únicamente de pruebas funcionales reales. Ver `docs/DECISIONS.md` D-102.
