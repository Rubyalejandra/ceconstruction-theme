...
- ⬜ 8.6 — QA-036 (foco de overlays: menú móvil, modales, lightbox) — 🟡 **integración de código completa** (utilidad `FocusTrap` en `assets/js/main.js`), pendiente únicamente de pruebas funcionales reales. Ver `docs/DECISIONS.md` D-104.
