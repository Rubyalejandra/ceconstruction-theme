...
- ⬜ 8.4 — QA-032, QA-033, QA-034 (robustez del formulario de cotización: race condition del rate-limit, archivo huérfano, sin idempotencia) — 🟡 **integración de código completa** (`inc/form-guards.php` nuevo; `inc/quote-form.php`, `functions.php`, `template-parts/quote-form.php` modificados), pendiente únicamente de pruebas funcionales reales. Ver `docs/DECISIONS.md` D-098/D-099.
